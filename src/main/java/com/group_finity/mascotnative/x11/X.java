...
public class X {
    ...
    private static X11Ext x11Ext = (X11Ext) Native.loadLibrary("X11", X11Ext.class);
    ...
    public static class Window {
         ...
         * @throws X11Exception thrown if X11 window errors occurred
         */
        public int getIntProperty(Atom xa_prop_type, Atom xa_prop_name) throws X11Exception {
         ...
         * @throws X11Exception thrown if X11 window errors occurred
         */
        public int getIntProperty(Atom xa_prop_type, String xa_prop_name) throws X11Exception {
        ...
        public void move(Window window, Point point) {
            x11Ext.XMoveWindow(display.getX11Display(), window.getX11Window(), point.x, point.y);
        }
